const ValueCard = ({ value }) => {
  ...
  return (
    <div className="group rounded-2xl border border-[#ffffff1a] bg-[#ffffff0c] p-6 transition-all duration-300 ease-in-out hover:-translate-y-1 hover:border-[#00F3FF]/50 hover:shadow-[0_0_30px_-6px_#00F3FF]">
      <div
